...
class CRUDTest(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        subprocess.run('bash ./integration/utils/start-server.sh {}'.format(cls.api_path).split(' '))
    ...
    def test_put(self):
        ...
        request = urllib.request.Request(url='http://localhost:8000/students/1', data=data.encode(encoding='utf-8'),
                                         method='PUT')
